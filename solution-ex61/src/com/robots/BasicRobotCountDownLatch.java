...
public abstract class BasicRobotCountDownLatch implements Robot {
...
//robots when 8 of them have congregated at the line x=50.
	...
	private static CountDownLatch cdl = new CountDownLatch(8); //Edit this
...
//count is down to zero.
						...
						synchronized (BasicRobotCountDownLatch.this) {
							switch (direction) {
							case EAST:
								x = (x + 1) % 200;
								break;
					...
					System.out.println("Ending Fuel is "
							+ BasicRobotCyclicBarrier.getFuel().getAmount());
	...
	public static void setSpeed(int speed) {
		BasicRobotCyclicBarrier.speed.set(speed);
	}
