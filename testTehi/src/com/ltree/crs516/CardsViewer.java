...
public final class CardsViewer extends JPanel implements Observer {
	...
	public static void main(String[] args) {
		...
		CardsViewer viewer = new CardsViewer();
		frame.add(viewer);
		frame.pack();
		frame.setVisible(true);
		viewer.update(null, new int[] { 1, 2, 3, 4, 3, 2, 1, 2, 3, 4, 3, 2, 1 });
	}
