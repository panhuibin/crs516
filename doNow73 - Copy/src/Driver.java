...
//Note: This starts the Spring container which we are using for dependency injection		
		ApplicationContext context 
		= new ClassPathXmlApplicationContext("guiConfig.xml");

		WOD wod = new WOD("World Ocean Database Browser");

//Instead of creating the WODController	get it from the container. You will get it 
//together with its dependencies.
		
		//WODController controller = new WODController(wod);
		WODController controller = (WODController)context.getBean("wodController");
		
//Take a look at WODController.java in the controller package		
		controller.setOwningFrame(wod);
