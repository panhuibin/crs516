...
public interface DataService extends Iterable<Station>, Closeable {
	 ...
	 * @throws IOException
	 */
	IStation read(int recNo) throws RecordNotFoundException, IOException;
	 ...
	 * @return
	 */
	IStation read(Integer cruiseNumber, int index);
	...
	IStation read(int currentStation, boolean b) throws RecordNotFoundException, IOException;
