...
public final class JChartsAdapter implements ChartProvider {

	private static final Logger logger = LoggerFactory.getLogger(JChartsAdapter.class);
	...
	private class WODJChartpanel extends JPanel{
		...
		private ScatterPlotAxisChart chart;
		
		private WODJChartpanel(ScatterPlotAxisChart chart){
			this.chart = chart;
		}
