...
$
$
%TODO 1:<br/>&#160;&#160;obs1 = mock(Observer.class);<br/>&#160;&#160;obs2 = mock(Observer.class);<br/><br/>
...
$
$
%TODO 2:<br/>&#160;&#160;subject.addObserver(obs1);<br/>&#160;&#160;subject.addObserver(obs2);<br/><br/>
//TODO 3: Call the deal() method of subject		
@		subject.deal();
$
$
%TODO 3:<br/>&#160;&#160;subject.deal();<br/><br/>
...
$
$
%TODO 4:<br/>&#160;&#160;verify(obs1, times(1)).update(subject, ranksDealt);<br/>&#160;&#160;verify(obs2, times(1)).update(subject, ranksDealt);<br/><br/>
	}
