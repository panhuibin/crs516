...
%TODO 1:<br/>ApplicationContext context<br/>&#160;&#160; = new ClassPathXmlApplicationContext("guiConfig.xml");<br/>WOD wod = (WOD)context.getBean("wod");<br/><br/>
...
%TODO 1(later in instructor demo):<br/>ApplicationContext context<br/>&#160;&#160;= new AnnotationConfigApplicationContext(GuiConfig.class);<br/>WOD wod = (WOD)context.getBean("wod");<br/><br/>
