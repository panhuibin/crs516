...
%public String convert(int num) {<br />&#160;&#160;if (num < 0) {{<br />&#160;&#160;&#160;&#160;return "minus " + convert(-1 * num);{<br />&#160;&#160;}{<br />&#160;&#160;if(Math.abs(num)>20){{<br />&#160;&#160;&#160;&#160;throw new IllegalArgumentException("Out of range!");{<br />&#160;&#160;}{<br />&#160;&#160;return words[num];<br />}<br /><br />

%private static String[] words = new String[] { "zero", "one", "two", "three",{<br />&#160;&#160;"four", "five", "six", "seven", "eight", "nine", "ten",{<br />&#160;&#160;"eleven", "twelve", "thirteen", "fourteen", "fifteen",{<br />&#160;&#160;"sixteen", "seventeen", "eighteen", "nineteen", "twenty"};<br />
