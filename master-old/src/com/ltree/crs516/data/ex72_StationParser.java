...
%TODO 2:<br/>StationProxy stationProxy = new StationProxy();<br/><br/>
//TODO 3: Use the method readBasicInformation to get a Station.StationBuilder 
//with just the mandatory information		
$
$
@		Station.StationBuilder builder = readBasicInformation(stationString);
%TODO 3:<br/>Station.StationBuilder builder = readBasicInformation(stationString);<br/><br/>
//TODO 4: Get a Station from the builder
$
$
@		Station station = builder.build();
%TODO 4:<br/>Station station = builder.build();<br/><br/>
//TODO 5: Set the Station on the stationProxy.
$
$
@		stationProxy.setStation(station);
%TODO 5:<br/>stationProxy.setStation(station);<br/><br/>
//TODO 6: Return the StationProxy		
$
$		
@		return stationProxy;
%TODO 6:<br/>return stationProxy;<br/><br/>
$		return null;
	}
