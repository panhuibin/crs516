...
#		try {
^
^			//In  action1(), we measure the distance between each pair of
^			//stations two times. By using traditional for loops instead 
^			//of foreach loops re-write the method so that the distance between
^			//each pair of stations is only calculated once.
^		
...
%TODO 2:<br/>&#160;&#160;&#160;&#160;for (int i = 0; i < dataService.size(); i++) {<br/>&#160;&#160;&#160;&#160;&#160;&#160;Station station1 = dataService.read(i);<br/>&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;for (int j = i + 1; j < dataService.size(); j++) {<br/>&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;Station station2 = dataService.read(j);<br/>&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;maxDistance = Math.max(maxDistance,<br/>&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;calculateDistance(station1, station2,DistanceUnits.KILOMETERS));<br/>&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;}<br/>&#160;&#160;&#160;&#160;}
