...
%TODO 2:<br/> ExecutorService threadPool = Executors.newFixedThreadPool(4);<br/><br/>		
...
//(endPoint - cursor).			
%TODO 3:<br/> countDownLatch = new CountDownLatch(endPoint - cursor);<br/><br/>
@			countDownLatch = new CountDownLatch(endPoint - cursor);
&			countDownLatch = null;//Edit this.
^			countDownLatch = null;
...
%TODO 4:<br/> SingleStationReader task = new SingleStationReader(stationLocations, stationNumber);<br/><br/>				
@				SingleStationReader task = new SingleStationReader(stationLocations, stationNumber);
&				SingleStationReader task = null;//Edit this.
...
%TODO 5:<br/> threadPool.submit(task);<br/><br/>
...
@				logger.info("Countdown reached zero!");
...
%TODO 6:<br/> try {<br/>&#160;&#160;countDownLatch.await();<br/>&#160;&#160;logger.info("Countdown reached zero!");<br/>} catch (InterruptedException e) {<br/>&#160;&#160;e.printStackTrace();<br/>}<br/><br/>


//TODO 7: Increment the cursor by adding cacheSize to it.			
			
@			cursor += cacheSize;
%TODO 7:<br/> cursor += cacheSize;<br/><br/>
$			
