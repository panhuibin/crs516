...
%TODO 1:<br/>chartProvider.setSize(new Dimension(500,300));<br/>chartProvider.setData(tableData[0],tableData[i]);<br/><br/>				
...
%TODO 1:<br/>JPanel plotPanel = chartingProvider.getChartPanel();<br/><br/>
