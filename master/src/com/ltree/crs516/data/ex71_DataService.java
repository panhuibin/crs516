...
$	
@	public IStation read(int currentStation, boolean b) throws RecordNotFoundException, IOException;
%TODO 1: public IStation read(int currentStation, boolean b) throws RecordNotFoundException, IOException;
