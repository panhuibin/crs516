...
$
$
%TODO 2a:<br/>private final Double value;<br/>private final int sigFig;<br/>private final int totalFig;<br/>private final int precision;
...
$
$
%TODO 2b<br/>private String meaning = "";<br/>private int originatorsFlag = 0;<br/>private int qualityFlag = 0;<br/>private String qualityFlagString = "See Documentation";
...
%TODO 3a:<br/>public Builder(Double value, int sigFig, int totalFig, int precision) {<br/>&#160;&#160;this.value = value;<br/>&#160;&#160;this.sigFig = sigFig;<br/>&#160;&#160;this.totalFig = totalFig;<br/>&#160;&#160;this.precision = precision;<br/>}
...
$
$
%TDODO 4a:<br/>public Builder originatorsFlag(int val){<br/>&#160;&#160;originatorsFlag = val;<br/>&#160;&#160;return this;<br/>}
...
$
$
%TODO 4b:<br/>public Builder qualityFlag(int val){<br/>&#160;&#160;qualityFlag = val;<br/>&#160;&#160;return this;<br/>}
...
$
$
%TODO 4c:<br/>public Builder qualityFlagString(String val){<br/>&#160;&#160;qualityFlagString = val;<br/>&#160;&#160;return this;<br/>}
...
%TODO 5:<br/>return new Datum(this);<br/>
...
%TODO 6:<br/>sigFig = builder.sigFig;<br/>totalFig = builder.totalFig;<br/>precision = builder.precision;<br/>meaning = builder.meaning;<br/>originatorsFlag = builder.originatorsFlag;<br/>qualityFlag = builder.qualityFlag;<br/>qualityFlagString = builder.qualityFlagString;
	}
