...
@			.build();
%TODO 1:<br/>testSubject =<br/>&#160;&#160;new Builder(value,sigFig,totalFig,precision)<br/>&#160;&#160;.meaning(meaning)<br/>&#160;&#160;.originatorsFlag(originatorsFlag)<br/>&#160;&#160;.qualityFlag(qualityFlag)<br/>&#160;&#160;.qualityFlagString(qualityFlagString)<br/>&#160;&#160;.build();<br/>
	}
