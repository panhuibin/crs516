 ...
 */
//Note the annotation making this a container managed bean
 @Named("wodController")
...
//Note the annotation ot indicate that the DataService should be injected	
	@Inject @Named("fileBasedDataService")
	private DataService dataService;

//Go to the DataService class to see its annotations	
