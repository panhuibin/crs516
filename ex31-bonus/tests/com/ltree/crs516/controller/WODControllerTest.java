...
// TODO 1: Mock the owner (its interface type is WODClient) and the dataService.
		WODClient owner = mock(WODClient.class);//Edit this line.
		dataService = mock(DataService.class);//Edit this line.
...
// TODO 3: Make an instance of Station and store it in the variable station.
		...
		station = new Station();//Edit this line
...
// the input argument to the constructor.
		...
		testSubject = new WODController(owner);//Edit this line.
...
// TODO 7: Create a mock Observer.
		...
		observer = mock(Observer.class); //Edit this line.
